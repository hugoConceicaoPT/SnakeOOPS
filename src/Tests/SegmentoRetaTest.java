...
public class SegmentoRetaTest {
    ...
    public void testEquals() {
        assertFalse(new SegmentoReta(new Ponto(3,4),new Ponto(5,3)).equals(new SegmentoReta(new Ponto(5,5), new Ponto(10,3))));
        assertTrue(new SegmentoReta(new Ponto(2,3), new Ponto(5,3)).equals(new SegmentoReta(new Ponto(5,3), new Ponto(2,3))));
    }
    ...
    public void testArestasSeCruzam() {
        ...
        SegmentoReta segmentoReta3 = new SegmentoReta(new Ponto(2,0), new Ponto(7,2));
